      ...
      >
        <div class="py-1">
          <template v-if="account">
            ...
            <FingerprintTestMenuItem :account="account" @close="$emit('close')" />
...
import FingerprintTestMenuItem from '@/features/openai-fingerprint-test/FingerprintTestMenuItem.vue'
