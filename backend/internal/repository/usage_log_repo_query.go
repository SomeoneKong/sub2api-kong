...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		kongRequestFeatures       sql.NullString
	...
	log.KongRequestFeatures = kongRequestFeaturesFromNullJSON(kongRequestFeatures)
	if userAgent.Valid {
