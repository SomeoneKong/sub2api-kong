...
//
// 都是**最终上游模型名**，不是客户端别名。两个 sol 各自要配什么白名单，见
// config.DefaultKongTicketAcceptExtra 的注释（含"单出口供不上多个模型"那条推导）。
var KongDefaultGatedModels = []string{"gpt-6-astra", "gpt-6-sol", "gpt-5.6-sol"}
